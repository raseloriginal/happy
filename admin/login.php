...
// If already logged in to admin, redirect to dashboard
...
<head>
  ...
  <title>Admin Portal Login — Happy Bangladesh ERP</title>
  <meta name="description" content="Secure authentication for Happy Bangladesh ERP Admin Portal" />
  ...
  <style>
    ...
    * {
    ...
    body {
      ...
      background: linear-gradient(135deg, #020617 0%, #0b1329 50%, #1e3a8a 100%);
      color: var(--text-main);
      min-height: 100vh;
      display: flex;
      align-items: center;
  ...
  <div class="login-container">
    ...
    <form id="login-form">
      <div class="form-group">
        <label for="admin-email">Access Email</label>
        <div class="input-wrapper">
          <input id="admin-email" type="email" name="email" placeholder="admin@happy.com" required autocomplete="email" />
        </div>
      </div>

      <div class="form-group">
        <label for="admin-password">Security Token</label>
        <div class="input-wrapper">
          <input id="admin-password" type="password" name="password" placeholder="••••••••" required autocomplete="current-password" />
