...
echo '<div class="box"><h1>🏗️ Happy Bangladesh ERP Setup</h1><p>Initializing database and tables...</p></div>';
...
try {
    ...
    echo '<div class="box"><p class="ok">✓ Connected to MySQL</p>';

    // 2. Create Database
    $conn->query("CREATE DATABASE IF NOT EXISTS `".DB_NAME."` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci");
    $conn->select_db(DB_NAME);
    echo '<p class="ok">✓ Database created/selected: ' . DB_NAME . '</p>';
    ...
    echo '<p class="ok">✓ Schema imported successfully</p>';
    ...
    echo '<p class="ok">✓ Admin user created/updated (admin@happy.com / admin123)</p>';
    echo '</div>';
